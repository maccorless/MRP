...
const AUDIT_ACTIONS = [
  ...
  "duplicate_flag_raised", "duplicate_resolved", "export_generated",
  "pbn_submitted", "pbn_approved", "pbn_sent_to_acr", "quota_changed",
  "enr_submitted", "enr_decision_made", "sudo_initiated", "noc_direct_entry",
  "eoi_window_toggled", "application_unapproved", "application_unreturned",
  "pbn_unapproved", "enr_decision_revised", "feature_flag_state_changed",
  "feature_flag_enrollment_changed", "invitation_created", "invitation_accepted",
  "rejection_reversed", "unreject",
] as const;
...
export const ACTION_LABEL: Record<string, string> = {
  ...
  feature_flag_state_changed:      "Feature flag state changed",
  feature_flag_enrollment_changed: "Feature flag enrollment changed",
...
export const ACTION_BADGE: Record<string, string> = {
  ...
  rejection_reversed:              "bg-orange-100 text-orange-700",
  unreject:                        "bg-orange-100 text-orange-700",
  ...
  duplicate_resolved:              "bg-purple-100 text-purple-700",
  ...
  feature_flag_state_changed:      "bg-yellow-100 text-yellow-700",
  feature_flag_enrollment_changed: "bg-yellow-100 text-yellow-700",
  invitation_created:              "bg-blue-100 text-blue-700",
