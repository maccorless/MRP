          ...
          {[
            {
              label: "Home",
              href: "/admin/noc/home",
              desc: "Overview dashboard with key dates, your EoI window status, and a summary of application counts by status.",
            },
            {
              label: "EoI Queue",
            ...
            {
              label: "Settings",
              href: "/admin/noc/settings",
              desc: "Open or close your EoI acceptance window. When closed, new applications from your territory are blocked.",
            },
            {
              label: "Audit Trail",
