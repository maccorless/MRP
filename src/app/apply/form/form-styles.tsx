...
export const BASE_INPUT =
  "w-full border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#0057A8] focus:border-transparent";
export const INPUT = BASE_INPUT + " border-gray-300";
export const LABEL = "block text-sm font-medium text-gray-700 mb-1";
export const HELP = "text-xs text-gray-400 mt-1";
