...
// All 7 categories from the Excel spec, in order.
const CATEGORIES: Cat[] = [
  ...
  },
  {
    ...
    description: "Journalist specialising in a sport on the Olympic Games programme. Es accreditations include access to all disciplines of that sport.",
    max: 100,
  },
  {
    key: "EP",
    code: "EP",
    title: "Photographer",
    description: "Photographer meeting the same criteria as category E.",
    max: 100,
  },
  {
    key: "EPs",
    ...
    description: "Photographer specialising in a sport on the Olympic Games programme. EPs accreditations include access to all disciplines of that sport.",
    max: 100,
  },
  {
    key: "EC",
    code: "Ec",
    title: "Support Staff",
    description: "Office assistant, secretary, interpreter, etc. Access to the Main Press Centre only. Assigned only to an accredited press organisation or NOC with a private MPC office.",
    max: 100,
  },
  {
    key: "ET",
    code: "ET",
    title: "Technician",
    description: "Technical support personnel of major news agencies, organisations or photo agencies. Generally identified by those organisations that rent Rate Card and telecommunications equipment at the MPC.",
    max: 100,
  },
  {
    key: "ENR",
    ...
    description: "Non-media rights holding radio and/or television organisation. ENR accreditations are allocated only by the IOC in consultation with the NOC. Max 3.",
    max: 3,
  },
];
          ...
          >
            ...
            <div className="flex-shrink-0">
              ...
              <input
                ...
                className="w-20 border border-gray-300 rounded-md px-3 py-1.5 text-sm text-right focus:outline-none focus:ring-2 focus:ring-brand-blue focus:border-transparent"
              />
              ...
              <input
                ...
                value={(parseInt(values[cat.key], 10) || 0) > 0 ? "on" : ""}
              />
            </div>
          </div>
        ))}
